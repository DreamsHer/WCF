...
{
    public partial class FRM_DiTu : Form
    {
        FRM_JiaoYiDaTing myFRM_JiaoYiDaTing;
        public FRM_DiTu(FRM_JiaoYiDaTing FRM_JiaoYiDaTing)
        {
            InitializeComponent();
        ...
        //Load事件
        private void FRM_DiTu_Load(object sender, EventArgs e)
        {

        }

        //关闭
        private void FRM_DiTu_FormClosed(object sender, FormClosedEventArgs e)
        {
