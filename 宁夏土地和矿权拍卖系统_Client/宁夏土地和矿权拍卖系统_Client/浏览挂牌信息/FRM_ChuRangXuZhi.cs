...
namespace 宁夏土地和矿权拍卖系统_Client
{
    ...
    public partial class FRM_ChuRangXuZhi : Form
    {
        FRM_JiaoYiDaTing myFRM_JiaoYiDaTing;
        public FRM_ChuRangXuZhi(FRM_JiaoYiDaTing FRM_JiaoYiDaTing)
        {
            InitializeComponent();
        ...
        //打印
        private void btnChuRangGongGaoOnDaYin_Click(object sender, EventArgs e)
        {

        }

        //关闭
        private void btnChuRangXuZhiOnGuanBi_Click(object sender, EventArgs e)
        {
